...
-- 注意：
-- 1. service_type 复用 ServiceTypeEnum：1-陪玩 2-护航 3-趣味单
-- 2. 抽成比例为万分制：1500 = 15.00%
-- 3. delta_club_application 不继承 TenantBaseDO
-- 4. delta_club_profile 和 delta_club_service_scope 继承 TenantBaseDO
